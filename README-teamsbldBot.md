...
2. Give the bot a name (`Teamsbld Bot`), a handle (`teamsbldBot`) and a description
3. For the messaging endpoint, use this: `https://tEamsbld.azurewebsites.net/api/messages`
